...
class _ContentRowState extends State<ContentRow> {
  ...
  void _scrollToIndex(int index) {
    final cardWidth = 280.w + 16.w;
    final targetOffset = (index * cardWidth) - 100.w;
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: EdgeInsets.fromLTRB(32.w, 10.h, 32.w, 8.h),
            child: Row(
              children: [
                Text(
                  widget.title,
                ...
                const Spacer(),
                _ChevronButton(icon: Icons.chevron_left, onTap: () => _scrollBy(-450.w)),
                SizedBox(width: 4.w),
                _ChevronButton(icon: Icons.chevron_right, onTap: () => _scrollBy(450.w)),
              ],
            ),
          ),
          SizedBox(
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon, size: 14.sp, color: Colors.white.withValues(alpha: 0.25)),
      ),
    );
  }
}
